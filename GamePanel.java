...
public  class GamePanel extends JPanel implements ActionListener{
     ...
     static final int SCREEN_HIEGHT =650;
     ...
     GamePanel(){
            random = new Random();
            this.setPreferredSize(new Dimension(SCREEN_HIEGHT,SCREEN_HIEGHT));
            this.setBackground(new Color(86,125,70));
